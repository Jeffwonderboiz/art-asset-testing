	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord368 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.BaseColor = ( _EmissionMultiply * tex2DNode369 ).rgb;
				...
				surfaceDescription.Emission = ( ( tex2D( _MaskTexture, ( appendResult436 * float2( 2,2 ) ) ).r + tex2DNode369 ) * _AlbedoPower ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord368 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles392 = 4.0 * 1.0;
				// Offsets for cols and rows of Flipbook Texture
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord368 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles392 = 4.0 * 1.0;
				// Offsets for cols and rows of Flipbook Texture
...
WireConnection;438;4;332;0
WireConnection;438;6;425;0
WireConnection;438;7;333;0
ASEEND*/
//CHKSM=8EB1F450536A0C5B6618ECEF58DD0523FB6843BF