	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar148 = TriplanarSampling148( _Emission, ase_worldPos, normalWS, 1.0, (0.001 + (_EmissionTilie - 0.0) * (0.1 - 0.001) / (1.0 - 0.0)), 1.0, 0 );
				
				float2 uv_SpecularSmooth = packedInput.ase_texcoord5.xy * _SpecularSmooth_ST.xy + _SpecularSmooth_ST.zw;
				
				float2 uv_AO = packedInput.ase_texcoord5.xy * _AO_ST.xy + _AO_ST.zw;
				
				surfaceDescription.BaseColor = ( _Color * tex2DNode144 ).rgb;
				...
				surfaceDescription.Emission = ( _EmissionMultiply * ( ( 1.0 - tex2DNode144.a ) * ( triplanar148 * _EmissionPower ) ) ).rgb;
				surfaceDescription.Smoothness = tex2D( _SpecularSmooth, uv_SpecularSmooth ).a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_SpecularSmooth = packedInput.ase_texcoord2.xy * _SpecularSmooth_ST.xy + _SpecularSmooth_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_SpecularSmooth = packedInput.ase_texcoord3.xy * _SpecularSmooth_ST.xy + _SpecularSmooth_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_SpecularSmooth = packedInput.ase_texcoord7.xy * _SpecularSmooth_ST.xy + _SpecularSmooth_ST.zw;
...
WireConnection;161;6;159;0
WireConnection;161;7;147;4
WireConnection;161;8;157;0
ASEEND*/
//CHKSM=30D6004345C0A9AD6487EEDA589C455843739DEB