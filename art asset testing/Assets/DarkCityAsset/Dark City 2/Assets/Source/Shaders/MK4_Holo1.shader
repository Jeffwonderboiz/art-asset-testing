...
Shader "MK4/Holo1"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Composite_ST;
			float4 _Color;
			float4 _ColorTexture_ST;
			float _Panner2;
			float _Panner1;
			float _Opacity;
			float _TextureExposition;
						...
						)
			{
				...
				float2 uv_Composite = packedInput.ase_texcoord5.xy * _Composite_ST.xy + _Composite_ST.zw;
				float2 panner6 = ( ( ( _TimeParameters.x ) * _Panner2 ) * float2( -0.1,0 ) + texCoord5);
				float2 panner11 = ( ( ( _TimeParameters.x ) * _Panner1 ) * float2( 0,0.2 ) + texCoord5);
				float4 clampResult18 = clamp( ( ( (0.95 + (sin( ( ( _TimeParameters.x ) * 60.0 ) ) - 0.0) * (1.0 - 0.95) / (1.0 - 0.0)) * ( tex2D( _Composite, panner14 ).g + ( ( tex2DNode2 + ( tex2D( _Composite, uv_Composite ).b * tex2D( _Composite, panner6 ).a ) ) + ( tex2DNode2.a * tex2D( _Composite, panner11 ).r ) ) ) ) * _Opacity ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				surfaceDescription.BaseColor = ( clampResult18 * staticSwitch20 ).rgb;
				...
				surfaceDescription.Emission = clampResult18.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord5 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * float2( 0,0.5 ) + texCoord5);
				float4 tex2DNode2 = tex2D( _Emission, texCoord5 );
				float2 uv_Composite = packedInput.ase_texcoord2.xy * _Composite_ST.xy + _Composite_ST.zw;
				float2 panner6 = ( ( ( _TimeParameters.x ) * _Panner2 ) * float2( -0.1,0 ) + texCoord5);
				float2 panner11 = ( ( ( _TimeParameters.x ) * _Panner1 ) * float2( 0,0.2 ) + texCoord5);
				float4 clampResult18 = clamp( ( ( (0.95 + (sin( ( ( _TimeParameters.x ) * 60.0 ) ) - 0.0) * (1.0 - 0.95) / (1.0 - 0.0)) * ( tex2D( _Composite, panner14 ).g + ( ( tex2DNode2 + ( tex2D( _Composite, uv_Composite ).b * tex2D( _Composite, panner6 ).a ) ) + ( tex2DNode2.a * tex2D( _Composite, panner11 ).r ) ) ) ) * _Opacity ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 panner14 = ( 1.0 * _Time.y * float2( 0,0.5 ) + texCoord5);
				float4 tex2DNode2 = tex2D( _Emission, texCoord5 );
				float2 uv_Composite = packedInput.ase_texcoord7.xy * _Composite_ST.xy + _Composite_ST.zw;
				float2 panner6 = ( ( ( _TimeParameters.x ) * _Panner2 ) * float2( -0.1,0 ) + texCoord5);
				float2 panner11 = ( ( ( _TimeParameters.x ) * _Panner1 ) * float2( 0,0.2 ) + texCoord5);
				float4 clampResult18 = clamp( ( ( (0.95 + (sin( ( ( _TimeParameters.x ) * 60.0 ) ) - 0.0) * (1.0 - 0.95) / (1.0 - 0.0)) * ( tex2D( _Composite, panner14 ).g + ( ( tex2DNode2 + ( tex2D( _Composite, uv_Composite ).b * tex2D( _Composite, panner6 ).a ) ) + ( tex2DNode2.a * tex2D( _Composite, panner11 ).r ) ) ) ) * _Opacity ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.TimeNode;38;-1772.585,396.4132;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;42;-1638.929,113.4177;Float;False;Property;_Panner2;Panner2;8;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1714.436,545.4342;Float;False;Property;_Panner1;Panner1;7;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;5;-1624.054,-35.6908;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-1224.933,43.92215;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1317.203,166.082;Float;True;Property;_Composite;Composite;1;0;Create;True;0;0;0;False;0;False;27893138eecb41f4a96d9b8c35a85d0a;27893138eecb41f4a96d9b8c35a85d0a;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-1411.436,429.4342;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;11;-1139.642,387.1957;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.2;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1;-1270.069,-510.6367;Float;True;Property;_Emission;Emission;0;0;Create;True;0;0;0;False;0;False;a58b4b73606fe4a489e868e62ff51987;a58b4b73606fe4a489e868e62ff51987;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;15;-836.83,570.4422;Inherit;True;Property;_TextureSample4;Texture Sample 4;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SinOpNode;28;53.44575,471.7511;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-198.0858,-284.6392;Float;False;Property;_TextureExposition;Texture Exposition;5;0;Create;True;0;0;0;False;0;False;0;0.431;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;33;212.6656,435.7004;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.95;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;21;-25.83435,-836.4863;Inherit;True;Property;_ColorTexture;Color Texture;4;0;Create;True;0;0;0;False;0;False;-1;8da6a4a3986ebf0448544f0e797ceb6f;8da6a4a3986ebf0448544f0e797ceb6f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorSpaceDouble;23;-41.15273,-627.1631;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;652.8076,384.9246;Float;True;Property;_Opacity;Opacity;6;0;Create;True;0;0;0;False;0;False;0;0.702;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;17;172.2655,-216.6421;Float;False;Property;_Color;Color;2;1;[HDR];Create;True;0;0;0;False;0;False;1,0.8168357,0.05147058,0;0.07992861,1.053603,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;43;6;18;0
WireConnection;54;0;18;0
WireConnection;54;1;20;0
ASEEND*/
//CHKSM=42C0C29C6A0986B3C07C0534FDCBBEBBDE17A204