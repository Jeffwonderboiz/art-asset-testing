	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( tex2D( _LED, uv_LED ) * _EmissionLED ) + ( tex2DNode66 * _EmissionAlbedo ) ).rgb;
				...
				surfaceDescription.Emission = ( _Color * tex2DNode66 ).rgb;
...
WireConnection;290;0;269;0
WireConnection;290;6;121;0
WireConnection;290;7;216;0
ASEEND*/
//CHKSM=71F5B4504785A309E0F9E5B4AE601A0FEA26910C