	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord311 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner337 = ( ( _TimeParameters.x ) * float2( 0,0.5 ) + texCoord311);
				float2 texCoord359 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.BaseColor = ( lerpResult335 * _EmissionPower ).rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = _Specular;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( lerpResult335 * _AlbedoPower ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord311 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner337 = ( ( _TimeParameters.x ) * float2( 0,0.5 ) + texCoord311);
				float2 texCoord359 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner360 = ( 1.0 * _Time.y * float2( 7,9 ) + texCoord359);
				float temp_output_362_0 = ( ( _TimeParameters.x * 3 ) * 20.0 );
				float clampResult372 = clamp( ( sin( ( temp_output_362_0 * 0.7 ) ) + sin( temp_output_362_0 ) + sin( ( temp_output_362_0 * 1.3 ) ) + sin( ( temp_output_362_0 * 2.5 ) ) ) , 0.0 , 1.0 );
				float2 temp_output_361_0 = ( texCoord311 + ( ( tex2D( _Texture0, panner360 ).b * clampResult372 ) * _Distort ) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord311 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner337 = ( ( _TimeParameters.x ) * float2( 0,0.5 ) + texCoord311);
				float2 texCoord359 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner360 = ( 1.0 * _Time.y * float2( 7,9 ) + texCoord359);
				float temp_output_362_0 = ( ( _TimeParameters.x * 3 ) * 20.0 );
				float clampResult372 = clamp( ( sin( ( temp_output_362_0 * 0.7 ) ) + sin( temp_output_362_0 ) + sin( ( temp_output_362_0 * 1.3 ) ) + sin( ( temp_output_362_0 * 2.5 ) ) ) , 0.0 , 1.0 );
				float2 temp_output_361_0 = ( texCoord311 + ( ( tex2D( _Texture0, panner360 ).b * clampResult372 ) * _Distort ) );
...
WireConnection;376;0;322;0
WireConnection;376;4;220;0
WireConnection;376;6;324;0
WireConnection;376;7;216;0
ASEEND*/
//CHKSM=8C576D984DBAA27EB8097742DB163128517390B9