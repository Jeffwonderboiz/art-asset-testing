	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlbedoMaskA = packedInput.ase_texcoord5.xy * _AlbedoMaskA_ST.xy + _AlbedoMaskA_ST.zw;
				...
				float2 uv_MetallicGloss = packedInput.ase_texcoord5.xy * _MetallicGloss_ST.xy + _MetallicGloss_ST.zw;
				...
				surfaceDescription.BaseColor = lerpResult7.rgb;
				...
				surfaceDescription.Emission = lerpResult13.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMaskA = packedInput.ase_texcoord2.xy * _AlbedoMaskA_ST.xy + _AlbedoMaskA_ST.zw;
				float4 tex2DNode2 = tex2D( _AlbedoMaskA, uv_AlbedoMaskA );
				float4 lerpResult7 = lerp( tex2DNode2 , _MaskColor , tex2DNode2.a);
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMaskA = packedInput.ase_texcoord7.xy * _AlbedoMaskA_ST.xy + _AlbedoMaskA_ST.zw;
				float4 tex2DNode2 = tex2D( _AlbedoMaskA, uv_AlbedoMaskA );
				float4 lerpResult7 = lerp( tex2DNode2 , _MaskColor , tex2DNode2.a);
				
				float2 uv_Normalmap = packedInput.ase_texcoord7.xy * _Normalmap_ST.xy + _Normalmap_ST.zw;
				
				float2 uv_MetallicGloss = packedInput.ase_texcoord7.xy * _MetallicGloss_ST.xy + _MetallicGloss_ST.zw;
				float4 tex2DNode4 = tex2D( _MetallicGloss, uv_MetallicGloss );
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.ColorNode;10;-559.3211,215.5461;Float;False;Property;_EmissionColor;Emission Color;6;1;[HDR];Create;True;0;0;0;False;0;False;0.5,0.5,0.5,0;0.2733179,0.3499477,0.6981132,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;6;-879.1072,289.7104;Inherit;True;Property;_Emission;Emission;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-885.2346,-81.82604;Inherit;True;Property;_AlbedoMaskA;Albedo Mask (A);0;0;Create;True;0;0;0;False;0;False;-1;None;3da6c980a24bcc34db5eb63c28fba902;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;8;-828.0997,-313.4736;Float;False;Property;_MaskColor;Mask Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6792453,0.5279494,0.2082591,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;5;-893.7916,714.4851;Inherit;True;Property;_AO;AO;7;0;Create;True;0;0;0;False;0;False;-1;None;41052a2f88d281f4cb6759bb01eaa4e3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-885.7267,104.5547;Inherit;True;Property;_Normalmap;Normalmap;2;0;Create;True;0;0;0;False;0;False;-1;None;2c797e8cee6a83c488f91ff0e4ccd103;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;14;7;4;4
ASEEND*/
//CHKSM=7DAC6711A3E0EB1A3CB8CD5F19BD3C683959234D