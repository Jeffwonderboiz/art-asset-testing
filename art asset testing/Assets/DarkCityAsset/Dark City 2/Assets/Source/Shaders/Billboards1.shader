...
Shader "MK4/Billboards"
{
	Properties
	{
		...
		[HDR]_LogoColor("LogoColor", Color) = (1,1,1,0)
		_Logo("Logo", 2D) = "black" {}
		...
		[HDR]_AlbedoColor("Albedo Color", Color) = (0.490566,0.490566,0.490566,0)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Logo = packedInput.ase_texcoord5.xy * _Logo_ST.xy + _Logo_ST.zw;
				float2 uv_LED = packedInput.ase_texcoord5.xy * _LED_ST.xy + _LED_ST.zw;
				...
				float4 tex2DNode210 = tex2D( _Logo, ( panner219 + temp_output_216_0 ) );
				float4 tex2DNode244 = tex2D( _Background, ( uv_Logo + temp_output_216_0 ) );
				float4 clampResult284 = clamp( ( ( ( clampResult295 * ( ( ( _Glitch1 * tex2D( _LEDGlow, panner257 ).g ) + ( ( _Glitch2 * tex2D( _LEDGlow, panner255 ).r ) + ( tex2DNode249 * clampResult280 ) ) ) * _LEDint ) ) + ( ( tex2DNode210 * _LogoColor ) * tex2DNode210 ) ) + ( tex2DNode244 * _BackgroundEm ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				
				surfaceDescription.BaseColor = clampResult284.rgb;
				...
				surfaceDescription.Emission = ( _AlbedoColor * tex2DNode244 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Logo = packedInput.ase_texcoord2.xy * _Logo_ST.xy + _Logo_ST.zw;
				float2 uv_LED = packedInput.ase_texcoord2.xy * _LED_ST.xy + _LED_ST.zw;
				float4 tex2DNode249 = tex2D( _LED, uv_LED );
				float2 temp_output_272_0 = ( uv_Logo + ( tex2DNode249.a * 0.1 ) );
				float2 panner267 = ( 1.0 * _Time.y * float2( -6,5 ) + temp_output_272_0);
				float clampResult295 = clamp( ( _GlitchIntensity + tex2D( _LEDGlow, panner267 ).a ) , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Logo = packedInput.ase_texcoord7.xy * _Logo_ST.xy + _Logo_ST.zw;
				float2 uv_LED = packedInput.ase_texcoord7.xy * _LED_ST.xy + _LED_ST.zw;
				float4 tex2DNode249 = tex2D( _LED, uv_LED );
				float2 temp_output_272_0 = ( uv_Logo + ( tex2DNode249.a * 0.1 ) );
				float2 panner267 = ( 1.0 * _Time.y * float2( -6,5 ) + temp_output_272_0);
				float clampResult295 = clamp( ( _GlitchIntensity + tex2D( _LEDGlow, panner267 ).a ) , 0.0 , 1.0 );
...
Node;AmplifyShaderEditor.TexturePropertyNode;224;478.1371,373.2149;Float;True;Property;_Distortions;Distortions;5;0;Create;True;0;0;0;False;0;False;63fe5b98ec4b4364dbbb1da0dce1ce3c;63fe5b98ec4b4364dbbb1da0dce1ce3c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;253;1344.555,762.0715;Float;True;Property;_LEDGlow;LED Glow;12;0;Create;True;0;0;0;False;0;False;27642ca2a9fa91649812bb3bade99fd6;27642ca2a9fa91649812bb3bade99fd6;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;265;1733.723,600.1031;Float;False;Property;_Glitch2;Glitch2;14;0;Create;True;0;0;0;False;0;False;0.5588235,0.08093307,0,0;0.2358491,0.1079121,0.1079121,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;287;900.2725,-330.0593;Float;False;Property;_PannerX;Panner X;2;0;Create;True;0;0;0;False;0;False;0;0.16;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;261;1963.257,1026.448;Float;False;Property;_Glitch1;Glitch1;13;0;Create;True;0;0;0;False;0;False;0.5197807,0.4306336,0.9926471,0;0.3372641,0.5,0.3989463,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;291;2258.916,510.9701;Float;False;Property;_GlitchIntensity;Glitch Intensity;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;2152.547,46.00183;Float;False;Property;_LEDint;LED int;9;0;Create;True;0;0;0;False;0;False;0;0.785;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;244;1547.187,-670.547;Inherit;True;Property;_Background;Background;7;0;Create;True;0;0;0;False;0;False;-1;733e51b801e31d843a87c82e435547d9;733e51b801e31d843a87c82e435547d9;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;300;6;247;0
WireConnection;300;7;299;0
WireConnection;210;1;214;0
WireConnection;264;0;311;0
WireConnection;264;1;210;0
WireConnection;311;0;210;0
WireConnection;311;1;312;0
ASEEND*/
//CHKSM=7BA06190EB0FDF60FA06F7B8DEA1CE1F74541360