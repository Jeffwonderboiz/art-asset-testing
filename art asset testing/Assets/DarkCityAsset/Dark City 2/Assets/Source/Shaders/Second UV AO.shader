	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord17 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord18 = packedInput.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.BaseColor = tex2D( _Albedo, texCoord17 ).rgb;
				...
				surfaceDescription.Smoothness = ( lerpResult21 * tex2DNode3.a ).r;
				surfaceDescription.Occlusion = clampResult13.r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord18 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode20 = tex2D( _AO2, texCoord18 );
				float4 lerpResult21 = lerp( float4( 1,1,1,0 ) , tex2DNode20 , _AO2GlossMultiply);
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord18 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode20 = tex2D( _AO2, texCoord18 );
				float4 lerpResult21 = lerp( float4( 1,1,1,0 ) , tex2DNode20 , _AO2GlossMultiply);
				float4 tex2DNode3 = tex2D( _MetalicGloss, texCoord17 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord17 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-249.7396,16.80003;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;24;4;3;0
WireConnection;24;7;23;0
WireConnection;24;8;13;0
ASEEND*/
//CHKSM=ADB1546D45E0E7D087BC253FC0643A56C6D1CC03