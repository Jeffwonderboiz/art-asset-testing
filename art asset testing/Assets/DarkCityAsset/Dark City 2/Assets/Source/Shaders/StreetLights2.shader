	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( lerpResult310 * _EmissionPower ).rgb;
				...
				surfaceDescription.Emission = ( lerpResult310 * _AlbedoPower ).rgb;
...
WireConnection;326;6;324;0
WireConnection;326;7;216;0
ASEEND*/
//CHKSM=86FAD3B34D1DFF10DEB13D120F9663FE6030F986